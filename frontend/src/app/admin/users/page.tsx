          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#0b1c30]/50">
                <th className="px-6 py-4 text-xs font-medium text-[#8c90a1] uppercase tracking-wider">Member Name</th>
                <th className="px-6 py-4 text-xs font-medium text-[#8c90a1] uppercase tracking-wider">Email</th>
                <th className="px-6 py-4 text-xs font-medium text-[#8c90a1] uppercase tracking-wider">Role</th>
                <th className="px-6 py-4 text-xs font-medium text-[#8c90a1] uppercase tracking-wider">Joined Date</th>
            ...
            <tbody className="divide-y divide-[#424656]/20">
              {users.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-6 py-8 text-center text-sm text-[#8c90a1]">No team members found.</td>
                </tr>
              ) : users.map((user) => (
                <tr key={user.id} className="hover:bg-[#102034]/30 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-[#8c90a1]">
