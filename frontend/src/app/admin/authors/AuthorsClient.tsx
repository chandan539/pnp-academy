          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#0b1c30]/50">
                <th className="px-6 py-4 text-xs font-medium text-[#8c90a1] uppercase tracking-wider">Author Details</th>
                <th className="px-6 py-4 text-xs font-medium text-[#8c90a1] uppercase tracking-wider">Contact</th>
                <th className="px-6 py-4 text-xs font-medium text-[#8c90a1] uppercase tracking-wider">Status</th>
                <th className="px-6 py-4 text-xs font-medium text-[#8c90a1] uppercase tracking-wider">Created</th>
                <th className="px-6 py-4 text-xs font-medium text-[#8c90a1] uppercase tracking-wider text-right">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#424656]/20">
              {filteredAuthors.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-6 py-8 text-center text-sm text-[#8c90a1]">No authors found in the system.</td>
                </tr>
                ...
                <tr key={author.id} className="hover:bg-[#102034]/30 transition-colors">
                  ...
                  <td className="px-6 py-4 text-xs text-[#8c90a1]">
          ...
          <div className="bg-[#0b1c30] border border-red-500/30 rounded-xl p-8 max-w-md w-full shadow-2xl shadow-red-900/20">
            ...
            <div className="flex justify-end gap-4 mt-8">
              ...
              <button 
                ...
                className="px-6 py-2 rounded-lg text-sm font-bold bg-red-600 text-white hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
