        ...
        <div className="p-6 md:p-10 space-y-10 max-w-[1600px] mx-auto w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="glass-panel p-6 rounded-xl group hover:border-[#ffb59d]/50 transition-all duration-500">
              ...
              <h3 className="text-3xl font-semibold text-[#d3e4fe] mt-2">842</h3>
              <div className="mt-6 h-12 w-full overflow-hidden">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-[#424656]/20">
                    <tr className="hover:bg-[#102034]/30 transition-colors">
                      <td className="px-6 py-4 flex items-center gap-4">
                        <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold">EV</div>
                        <div>
                          <p className="text-sm text-[#d3e4fe] font-medium">Elena Vance</p>
                          <p className="text-[11px] text-[#8c90a1]">Author since 2022</p>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <span className="inline-flex items-center px-2 py-1 rounded-full bg-[#b3c5ff]/10 text-[#b3c5ff] text-[10px] font-bold uppercase tracking-widest border border-[#b3c5ff]/20">Active</span>
                      </td>
                      <td className="px-6 py-4 text-sm text-[#c2c6d8]">Mastering Micro-SaaS</td>
                    </tr>
                    <tr className="hover:bg-[#102034]/30 transition-colors">
                      <td className="px-6 py-4 flex items-center gap-4">
                        <div className="w-10 h-10 rounded-full bg-[#ffb59d] flex items-center justify-center text-[#390c00] font-bold">JM</div>
                        <div>
                          <p className="text-sm text-[#d3e4fe] font-medium">Julian Moore</p>
                          <p className="text-[11px] text-[#8c90a1]">Author since 2023</p>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <span className="inline-flex items-center px-2 py-1 rounded-full bg-[#ffb59d]/10 text-[#ffb59d] text-[10px] font-bold uppercase tracking-widest border border-[#ffb59d]/20">Reviewing</span>
                      </td>
                      <td className="px-6 py-4 text-sm text-[#c2c6d8]">UI System Dynamics</td>
                    </tr>
                  </tbody>
                </table>
              </div>
