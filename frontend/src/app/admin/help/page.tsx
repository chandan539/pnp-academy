      ...
      <div className="glass-panel p-8 rounded-xl max-w-4xl mx-auto w-full">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#102034] p-6 rounded-lg border border-[#424656]">
            ...
            <ul className="list-disc list-inside text-sm text-[#8c90a1] space-y-1">
          ...
          <div className="bg-[#102034] p-6 rounded-lg border border-[#424656]">
            ...
            <p className="text-sm text-[#8c90a1] mb-2">
              <strong>To connect to Google Sheets directly:</strong>
            </p>
            <ol className="list-decimal list-inside text-sm text-[#8c90a1] space-y-2 mb-4">
  ...
  try {
    ...
    return ContentService.createTextOutput(JSON.stringify({"error": error.message}))
      .setMimeType(ContentService.MimeType.JSON);
            ...
            <p className="text-xs text-[#8c90a1] mt-4">
